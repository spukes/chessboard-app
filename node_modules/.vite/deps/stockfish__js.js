...
var require_stockfish_wasm = __commonJS({
  "node_modules/stockfish.js/stockfish.wasm.js"(exports, module) {
    ...
    ENVIRONMENT_IS_NODE ? (scriptDirectory = __dirname + "/", read_ = function(e, r) {
      var t;
      return nodeFS = nodeFS || require_fs(), e = (nodePath = nodePath || require_path()).normalize(e), t = nodeFS.readFileSync(e), r ? t : t.toString();
    }, readBinary = function(e) {
      var r = read_(e, true);
      return r.buffer || (r = new Uint8Array(r)), assert(r.buffer), r;
    }, 1 < process.argv.length && (thisProgram = process.argv[1].replace(/\\/g, "/")), arguments_ = process.argv.slice(2), "undefined" != typeof module && (module.exports = Module), process.on("uncaughtException", function(e) {
    ...
    function initRuntime() {
      runtimeInitialized = true, Module.noFSInit || FS.init.initialized || FS.init(), TTY.init(), callRuntimeCallbacks(__ATINIT__);
    }
    function preMain() {
    ...
    function createWasm(e) {
      ...
      function t(e2, r2) {
        var t2 = e2.exports;
        Module.asm = t2, removeRunDependency("wasm-instantiate");
      }
      function n(e2) {
        t(e2.instance);
      }
    ...
    isDataURI(wasmBinaryFile) || (wasmBinaryFile = locateFile(wasmBinaryFile)), Module.asm = function(e, r, t) {
      return r.memory = wasmMemory, r.table = wasmTable = new WebAssembly.Table({ initial: 733, maximum: 733, element: "anyfunc" }), r.__memory_base = 1024, r.__table_base = 0, createWasm(r);
    ...
    function ___cxa_throw(e, r, t) {
      throw ___exception_infos[e] = { ptr: e, adjusted: [e], type: r, destructor: t, refcount: 0, caught: false, rethrown: false }, ___exception_last = e, "uncaught_exception" in __ZSt18uncaught_exceptionv ? __ZSt18uncaught_exceptionv.uncaught_exceptions++ : __ZSt18uncaught_exceptionv.uncaught_exceptions = 1, e;
    }
    ...
    var MEMFS = { ops_table: null, mount: function(e) {
    ...
    var WORKERFS = { DIR_MODE: 16895, FILE_MODE: 33279, reader: null, mount: function(e) {
    ...
    var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, trackingDelegate: {}, tracking: { openFlags: { READ: 1, WRITE: 2 } }, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, handleFSError: function(e) {
      ...
      Browser.init();
      var m = i ? PATH_FS.resolve(PATH.join2(o, i)) : o, p = getUniqueRunDependency("cp " + m);
      function r(r2) {
        function t(e2) {
          f && f(), c || FS.createDataFile(o, i, e2, a, s, d), u && u(), removeRunDependency(p);
        }
        var n = false;
      ...
      addRunDependency(p), "string" == typeof e ? Browser.asyncLoad(e, function(e2) {
        r(e2);
      }, l) : r(e);
    }, indexedDB: function() {
    ...
    var SYSCALLS = { DEFAULT_POLLMASK: 5, mappings: {}, umask: 511, calculateAt: function(e, r) {
      if ("/" !== r[0]) {
        var t;
        if (-100 === e) t = FS.cwd();
        else {
    ...
    function __emscripten_syscall_munmap(e, r) {
      ...
      if (r === t.len) {
        ...
        SYSCALLS.doMsync(e, n, r, t.flags), FS.munmap(n), SYSCALLS.mappings[e] = null, t.allocated && _free(t.malloc);
      }
      return 0;
    }
    ...
    function _emscripten_set_main_loop(e, r, t, n, o) {
      ...
      }, o || (r && 0 < r ? _emscripten_set_main_loop_timing(0, 1e3 / r) : _emscripten_set_main_loop_timing(1, 1), Browser.mainLoop.scheduler()), t) throw "SimulateInfiniteLoop";
    }
    var Browser = { mainLoop: { scheduler: null, method: "", currentlyRunningMainloop: 0, func: null, arg: 0, timingMode: 0, timingValue: 0, currentFrameNumber: 0, queue: [], pause: function() {
      ...
      Browser.mainLoop.func = null, _emscripten_set_main_loop(t, 0, false, Browser.mainLoop.arg, true), _emscripten_set_main_loop_timing(e, r), Browser.mainLoop.scheduler();
      ...
      readAsync(r, function(e2) {
        assert(e2, 'Loading data file "' + r + '" failed (no arrayBuffer).'), t(new Uint8Array(e2)), o && removeRunDependency(o);
      }, function(e2) {
    ...
    if (FS.staticInit(), ENVIRONMENT_HAS_NODE) {
      fs = require_fs(), NODEJS_PATH = require_path();
      NODEFS.staticInit();
    }
    var fs;
    var NODEJS_PATH;
    function intArrayFromString(e, r, t) {
      var n = 0 < t ? t : lengthBytesUTF8(e) + 1, o = new Array(n), i = stringToUTF8Array(e, o, 0, o.length);
    ...
    var asmGlobalArg = {};
    var asmLibraryArg = { c: abort, r: setTempRet0, x: getTempRet0, w: ___atomic_fetch_add_8, e: ___cxa_allocate_exception, d: ___cxa_throw, v: ___cxa_uncaught_exceptions, i: ___lock, u: ___map_file, l: ___setErrNo, t: ___syscall140, s: ___syscall145, q: ___syscall146, p: ___syscall221, M: ___syscall5, o: ___syscall54, n: ___syscall6, L: ___syscall91, h: ___unlock, b: _abort, K: _clock_gettime, k: _emscripten_async_call, J: _emscripten_get_heap_size, I: _emscripten_memcpy_big, H: _emscripten_resize_heap, G: _exit, j: _getenv, g: _llvm_stackrestore, f: _llvm_stacksave, F: _pthread_attr_init, E: _pthread_attr_setstacksize, D: _pthread_cond_destroy, C: _pthread_cond_signal, m: _pthread_cond_wait, B: _pthread_create, A: _pthread_join, z: _strftime_l, y: abortOnCannotGrowMemory, a: DYNAMICTOP_PTR };
    ...
    function exit(e, r) {
      r && Module.noExitRuntime && 0 === e || (Module.noExitRuntime || (ABORT = true, EXITSTATUS = e, exitRuntime(), Module.onExit && Module.onExit(e)), quit_(e, new ExitStatus(e)));
    }
    function abort(e) {
      throw Module.onAbort && Module.onAbort(e), out(e += ""), err(e), ABORT = true, EXITSTATUS = 1, "abort(" + e + "). Build with -s ASSERTIONS=1 for more info.";
    }
...
export default require_stockfish_wasm();
...
stockfish.js/stockfish.wasm.js:
   ...
   *)
*/
//# sourceMappingURL=stockfish__js.js.map
